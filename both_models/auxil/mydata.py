...
#GPL-3.0 licensed
#This code provides functionality for loading HSI images, their ground truth, and the number of classes
#Additionally, it contains functions for creating patch cubes, padding and splitting data
...
def loadData(name, num_components=None, preprocessing="standard"):
    data_path = os.path.join(os.getcwd(),'inputData')
